onEvent("go", "click", function( ) {
  playSound("assets/Clicking-sound-effect.mp3", false);
});
...
onEvent("reset4", "click", function(event) {
  ...
  onEvent("yes", "click", function(event) {
    ...
    setNumber("scd", 5000);
    setNumber("sce", 50000);
    setNumber("scf", 500000);
    setNumber("scg", 5000000);
    setNumber("sch", 50000000);
    setNumber("sci", 999999999);
    setNumber("saa", 0);
    setNumber("sab", 0);
    setNumber("sac", 0);
    setNumber("sad", 0);
...
onEvent("button7", "click", function( ) {
	setText("money2", "999999999999");
	setText("money3", "999999999999");
	setText("money", "999999999999");
	setText("money4", "999999999999");
	setScreen("home");
});
onEvent("Settings", "click", function( ) {
	setScreen("settings");
});
onEvent("Kback", "click", function( ) {
	setScreen("home");
});
onEvent("Kbac", "click", function( ) {
	setScreen("home");
});
